...
Note: if the project is longitudinal and the event-form file with the event_path is not provided some steps of the preprocessment can not be performed.
...
There are 7 unchanged queries, 4 modified queries, and 1 new query between the previous and the new query dataset.
